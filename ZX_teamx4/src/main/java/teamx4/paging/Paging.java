...
public class Paging {
	...
	private int offset = 0 ; // 각 페이지 마다 건너뛰어야 할 레코드 갯수
	private int limit = 0 ; //한페이지에 보여줄 레코드 갯수
...
*/
	...
	public Paging(
		...
		// page1 : (1-1) * 2 = 0 , page2 : (2-1) * 2 = 2, page3 : (3-1) * 2 = 4
		// 각 페이지 마다 건너뛰어야 할 레코드 갯수
