    ...
    <div id="contents">
        ...
        <div id="subright-cont">
            ...
            <div id="review-form">
                ...
                <!-- form -->
                <form id="frm_action" method="POST" action="reviewForm.tm?restNum=${cb.restNum}" enctype="multipart/form-data">
                ...
                <div class="section">
                    ...
                    <div class="score_box">
                        <div>
                            ...
                            <div class="score_star radio_score" data-type="taste"><input type="radio" id="taste1"  name="reviewTaste" class="score" value="1"><input type="radio" id="taste2"  name="reviewTaste" class="score" value="3"><input type="radio" id="taste3"  name="reviewTaste" class="score" value="5"><label for='taste1' class='score_text'>맛없음</label><label for='taste2' class='score_text'>보통</label><label for='taste3' class='score_text'>맛있음</label></div>
                            <div class="clear"></div>
                        </div>
                        <div style="margin:32px 0;">
                            <div class="fl">가격 평가</div>
                            <div class="score_star radio_score" data-type="price"><input type="radio" id="price1"  name="reviewPrice" class="score" value="1"><input type="radio" id="price2"  name="reviewPrice" class="score" value="3"><input type="radio" id="price3"  name="reviewPrice" class="score" value="5"><label for='price1' class='score_text'>가격불만</label><label for='price2' class='score_text'>보통</label><label for='price3' class='score_text'>가격만족</label></div>
                            <div class="clear"></div>
                        </div>
                        <div>
                            <div class="fl">서비스 평가</div>
                            <div class="score_star radio_score" data-type="service"><input type="radio" id="service1" name="reviewService" class="score" value="1"><input type="radio" id="service2" name="reviewService" class="score" value="3"><input type="radio" id="service3" name="reviewService" class="score" value="5"><label for='service1' class='score_text'>불친절</label><label for='service2' class='score_text'>보통</label><label for='service3' class='score_text'>친절함</label></div>
                            <div class="clear"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <textarea id="txt_contents" name="reviewContent" class="fs-13" placeholder="음식, 서비스, 분위기, 위생상태 등의 방문 경험을 적어주세요." style="border:solid 1px #D5D5D5; width:100%; height:120px;"></textarea>
                ...
                <div class="section">
                    ...
                    <button id="btn_save" type="submit" style="background-color:#ff7100;" class="btn btn-black w240">평가제출</button>
               		</div>
                                    </form>
